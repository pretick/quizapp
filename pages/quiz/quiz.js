                ...
                <section class="alternativas">
                    <form action="">
                        <label for="alternativa_a">
                            <input type="radio" id="alternativa_a" name="alternativa" value="${alterarSinais(quiz.question[perunta-1].options[0])}">

                            <div>
                                <span>A</span>
                                ${alterarSinais(quiz.question[perunta-1].options[0])}
                            </div>
                        </label>
